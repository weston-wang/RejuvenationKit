...
6. computes descriptive RAP-minus-control log2 CPM differences within each age/sex stratum; and
7. optionally writes a sample manifest, QC report, and descriptive results.
